// ======================================================================
//  PROXY DE STREAMING - Proxy universal para streaming
//  Suporta modo direct, controle de conexões e múltiplos dispositivos
// ======================================================================
...
$pass = $_GET['pass'] ?? '';
$id = $_GET['id'] ?? 0;
$direct = $_GET['direct'] ?? 0; // Se 1, redireciona diretamente sem proxy
...
// Se modo direct ativado, redireciona diretamente
if ($direct == 1) {
...
curl_setopt($ch, CURLOPT_HEADER, false); // Não incluir headers na saída
...
// Headers para diferentes serviços
$headers = [
    'Accept: */*',
    'Accept-Language: pt-BR,pt;q=0.9,en-US;q=0.8,en;q=0.7',
];

// Se for StreamFlow ou serviços específicos
$is_streamflow = (
...
if ($is_streamflow) {
    ...
    $headers[] = 'Referer: https://utrafix.qualidade.cloud/';
    $headers[] = 'Origin: https://utrafix.qualidade.cloud';
}
