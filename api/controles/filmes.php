...
function adicionar_filmes()
{
    ...
    if ($row = $stmt->fetch()) {
        ...
        $modal_body .= '<div class="input-group-text mb-1 m-1">
                                    <span class="input-group-text" style=" min-width: 200px">TMDB do Filme:</span>
                                    <input type="text" class="form-control " id="tmdb" name="tmdb" value="" autocomplete="off">
                                    <button onclick="buscarDadosPeloTMDB()" type="button" style="margin-left: 10px" class="btn btn-primary btn-sm">Buscar</button>
        ...
        $modal_body .= '<div class="input-group-text mb-1 m-1">
                                    ...
                                    <input type="text" class="form-control " name="director" id="director" value="" autocomplete="off" placeholder="ex: Riley Flanagan, Jaume Collet-Serra, Jaume Collet-Serra">
                                </div>';
        $modal_body .= '<div class="input-group-text mb-1 m-1">
                                    <span class="input-group-text" style=" min-width: 200px">Data de lançamento:</span>
                                    <input type="date" class="form-control " name="releasedate" id="releasedate" value="" autocomplete="off" placeholder="ex: 05-12-24">
                                </div>';
        $modal_body .= '<div class="input-group-text mb-1 m-1">
                                    <span class="input-group-text" style=" min-width: 200px">Duraçao:</span>
                                    <input type="time" step="2" class="form-control " name="duration" id="duration" value="" autocomplete="off" placeholder="ex: 01:59:40">
                                </div>';
        $modal_body .= '<div class="input-group-text mb-1 m-1">
        ...
        $modal_body .= '<div class="input-group-text mb-1 m-1">
                                    ...
                                    <input type="text" class="form-control " name="genre" id="genre" value="" autocomplete="off" placeholder="ex: Mistério, Thriller, Ação">
                                </div>';
        $modal_body .= '</div>';
        $modal_body .= '</div>';
        ...
        $modal_body .= '<div class="form-row input-group-text m-1">
                        <span class="input-group-text" style=" min-width: 200px">Elenco:</span>
                        <input type="text" class="form-control " name="actors" id="actors" value="" autocomplete="off" placeholder="ex: Taron Egerton, Jason Bateman, Sofia Carson, Danielle Deadwyler, Dean Norris">
                        </div>';
        $modal_body .= '<div class="form-row input-group-text m-1 row">
                        <span class="input-group-text" style=" min-width: 200px">Descriçao:</span>
                        <textarea type="text" class="form-control " name="plot" id="plot" style="max-height: 150px;height: 100px;" placeholder="Digite ou cole a Descrição aqui"></textarea>
                        </div>';
        $modal_body .= '<div class="form-row input-group-text m-1">
                        <span class="input-group-text" style=" min-width: 200px">Avaliação:</span>
                        <input type="text" class="form-control " name="rating" id="rating" value="" placeholder="6.9">
                        </div>';
        $modal_body .= '<div class="form-row input-group-text m-1">
                        <span class="input-group-text" style=" min-width: 200px">Classificação de 5:</span>
                        <input type="text" class="form-control " name="rating_5based" id="rating_5based" value="" placeholder="valor maximo 5">
                        </div>';
        $modal_body .= '<div class="form-row input-group-text m-1">
                        <span class="input-group-text" style=" min-width: 200px">Link da (capa do Filme):</span>
     ...
     function buscarDadosPeloTMDB() {
    const tmdb = $("#tmdb").val();
    const url = "api/tmdb.php?get_filmes=" + tmdb;
...
function confirme_adicionar_filmes($nome, $link, $logo, $Categoria, $is_adult, $director, $genre, $actors, $plot, $backdrop_path, $releasedate, $duration, $rating, $rating_5based, $year, $tmdb)
{
    $conexao = conectar_bd();
    $resposta = [];
    ...
    if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $sql_insert = "INSERT INTO streams (name, link, stream_icon, stream_type, category_id, is_adult, director, genre, actors, plot, backdrop_path, releasedate, duration, rating, rating_5based, year, tmdb_id) 
                        VALUES (:name, :link, :stream_icon, :stream_type, :category_id, :is_adult, :director, :genre, :actors, :plot, :backdrop_path, :releasedate, :duration, :rating, :rating_5based, :year, :tmdb_id)";
        ...
        $stmt_insert->bindParam(':tmdb_id', $tmdb, PDO::PARAM_STR);
