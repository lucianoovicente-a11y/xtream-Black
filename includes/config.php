...
if (php_sapi_name() !== 'cli') {
    ...
    define('BASE_URL', $protocol . $host . '/streamblack/novo/');
} else {
    define('BASE_URL', 'http://localhost/streamblack/novo/');
}
...
define('SYSTEM_NAME', 'Prof. Luciano Vicente');
define('SYSTEM_VERSION', '1.0.0');
define('SYSTEM_AUTHOR', 'Prof. Luciano Vicente - 21971877485');
